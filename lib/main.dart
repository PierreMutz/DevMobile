...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        title: 'Liste des étudiants B1G1',
        home: new StudentList(title: 'Liste d\'élèves B1G1') //Titre de la page
    );
  }
}
                  ...
                  if(snapshot.data == null){
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index){
                        ...
                        return ListTile( //Balise qui comprend les noms et prénoms des élèves et les cases à cocher
                          title: Text("prénom : " + snapshot.data[index].lastName + "\n" + "nom : " + snapshot.data[index].firstName),
                          trailing: Icon(
                            alreadySaved ? Icons.radio_button_checked : Icons.radio_button_unchecked,
                            color :alreadySaved ? Colors.teal : null,  //case à cocher
                          ),
                        onTap: () {
                          setState(() {
                            if (alreadySaved) {
